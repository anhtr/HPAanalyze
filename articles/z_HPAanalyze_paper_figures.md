...
This code will only work with the version of HPAanalyze that is used to
generate the figures in the paper. Due to subsequent updates to the
package, the code may not work with the latest version of HPAanalyze.
