...
SLC2A3_norm <-
  subset(
     subset(SLC2A3_expr[[1]], tissueDescription1 == "Normal tissue, NOS"),
     tissueDescription2 %in% c("Cerebral cortex", "Hippocampus", "Lateral ventricle wall")
)
...
SLC2A3_glioma <-
  subset(SLC2A3_expr[[1]], tissueDescription1 %in% c("Glioma, malignant, High grade", 
