---
title: "HPAanalyze use case: Working with Human Protein Atlas (HPA) xml files offline"
author:
- name: Anh N. Tran
...
vignette: >
  %\VignetteIndexEntry{"HPAanalyze use case: Working with Human Protein Atlas (HPA) xml files offline"}
