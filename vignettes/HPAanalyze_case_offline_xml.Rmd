---
title: "HPAanalyze use case: Working with Human Protein Atlas xml files offline"
author:
- name: Anh N. Tran
...
vignette: >
  %\VignetteIndexEntry{"HPAanalyze use case: Working with Human Protein Atlas xml files offline"}
