---
title: "HPAanalyze in-depth: Working Human Protein Atlas data in R"
author:
- name: Anh N. Tran
...
vignette: >
  %\VignetteIndexEntry{"HPAanalyze in-depth: Working Human Protein Atlas data in R"}
...
```{r echo=FALSE, fig.cap="HPAanalyze workflow.", out.width = '120%'}
...
*If you leave the argument blank, this function with give you the results for version 18.*
