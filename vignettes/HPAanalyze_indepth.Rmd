---
title: "HPAanalyze in-depth: Working with Human Protein Atlas (HPA) data in R"
author:
- name: Anh N. Tran
...
vignette: >
  %\VignetteIndexEntry{"HPAanalyze in-depth: Working with Human Protein Atlas (HPA) data in R"}
