...
If you want everything the xml file contains rather than one specific piece of information, use `hpaXmlParse()` instead -- see the ["Parse an entire HPA xml file into relational tibbles"](g_HPAanalyze_case_relational_xml.html) vignette.
