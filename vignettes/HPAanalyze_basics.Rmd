...
# $ tissue      <chr> "adrenal gland", "appendix", "appendix", "bone ma...
# $ cell_type   <chr> "glandular cells", "glandular cells", "lymphoid t...
# $ level       <chr> "Not detected", "Medium", "Not detected", "Not de...
# $ reliability <chr> "Approved", "Approved", "Approved", "Approved", "...
```
...
```{r subcellular_location, eval=FALSE}
tibble::glimpse(downloaded_data$subcellular_location, give.attr = FALSE)

# Observations: 12,073
# Variables: 11
# $ ensembl                   <chr> "ENSG00000000003", "ENSG00000000457...
# $ gene                      <chr> "TSPAN6", "SCYL3", "C1orf112", "FGR...
# $ reliability               <chr> "Approved", "Uncertain", "Approved"...
# $ enhanced                  <chr> NA, NA, NA, NA, NA, NA, "Nucleoplas...
# $ supported                 <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA,...
# $ approved                  <chr> "Cytosol", NA, "Mitochondria", "Agg...
# $ uncertain                 <chr> NA, "Microtubules;Nuclear bodies", ...
# $ single_cell_var_intensity <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA,...
# $ single_cell_var_spatial   <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA,...
# $ cell_cycle_dependency     <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA,...
# $ go_id                     <chr> "Cytosol (GO:0005829)", "Microtubul...
```
...
# $ tissue  <chr> "adipose tissue", "adrenal gland", "appendix", "bone ...
# $ value   <dbl> 31.5, 26.4, 9.2, 0.7, 53.4, 18.5, 54.2, 48.5, 27.1, 3...
# $ unit    <chr> "TPM", "TPM", "TPM", "TPM", "TPM", "TPM", "TPM", "TPM...

tibble::glimpse(downloaded_data$rna_cell_line, give.attr = FALSE)

# Observations: 1,255,232
# Variables: 5
# $ ensembl   <chr> "ENSG00000000003", "ENSG00000000003", "ENSG00000000...
# $ gene      <chr> "TSPAN6", "TSPAN6", "TSPAN6", "TSPAN6", "TSPAN6", "...
# $ cell_line <chr> "A-431", "A549", "AF22", "AN3-CA", "ASC diff", "ASC...
# $ value     <dbl> 27.8, 37.6, 108.1, 51.8, 32.3, 17.7, 42.7, 14.9, 22...
# $ unit      <chr> "TPM", "TPM", "TPM", "TPM", "TPM", "TPM", "TPM", "T...
```
